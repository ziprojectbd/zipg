...
import paymentResultRoutes from './routes/paymentResult.routes.js';
...
apiV1.use('/payment-results', paymentResultRoutes);
...
apiLegacy.use('/payment-results', paymentResultRoutes);
